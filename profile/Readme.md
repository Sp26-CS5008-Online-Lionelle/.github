# Spring 2026 - Online - CS 5008/9 -- Data Structures, Algorithms, and their Applications in Computer Systems

|   &nbsp;|  &nbsp;   |
|:------ | :-------|
| Course Code & Title |  CS 5008: Data Structures, Algorithms, and their Applications in Computer Systems <br/> CS 5009:  Recitation for CS 5008 |
|Number of Credit Hours  | 4 |
|Semester & Year of Offering | Spring 2026 |
|Class Meeting Days & Times | No required meeting times, optional live session Thursday evenings. |
| Class Meeting Location | Online |
| Required Textbook or Materials | No textbook required <br> gcc 11+ <br> Github.com account required, <br> MS Teams required |

**Instructor:**  
Albert Lionelle (he,him,his)   
Associate Teaching Professor, Director of Align       
...
**Corequisite(s):** [CS 5009](https://catalog.northeastern.edu/search/?P=CS%205009)
...
| 6 | Dynamic Programming | Team Activity, Knowledge Check |
| 7 | Midterm Week | Knowledge Check - Summary, Midterm Report, Midterm - Reflection |
| 8 | Sequential Data Structures: Vectors and Linked Lists | Team Activity, Discussion Acivity, Knowledge Check |
| 9 | Sorted Structures, Trees, and Heaps | Team Activity, Homework: Data Structure Comparison, Knowledge Check |
| 10 | Graphs | Team Activity, Discussion Activity, Knowledge Check |
| 11 | Greedy Algorithms | Team Activity, Knowledge Check |
| 12 | Hash Tables | Team Activity, Homework: City Traveler, Knowledge Check |
| 13 | Proving Correctness of Algorithms (Preparing for 5800) | Knowledge Check: Full Concept Review |
| 14 | Final Project | Final Project Due |
...
**IMPORTANT**: Throughout the semester you will be expected to work on proofs to verify both the correctness and runtime of your code. You should not use generative AI to write your proofs. This will hamper your ability to understand the concepts, and will hurt you in future courses such as CS5800. 
